...
鉴于不同地区及运营商的 106 短信推送号段存在差异，项目不猜测或统一生成品牌短信号码。仓库中已有、来源明确的短信号码会使用带标签对象保存；收到某个机构的新短信后，可在对应 YAML 中补充：
...
标准 vCard 构建会保留明确标记为“短信”的 106 长号码；未标记的 106 长号码仍会过滤。CardDAV 构建会保留 YAML 中的全部号码。号码可能因运营商、地区和业务线变化，请以手机实际收到的发送号码及机构官方说明为准：
